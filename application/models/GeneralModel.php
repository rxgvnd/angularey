...
class GeneralModel extends CI_Model
{
  ...
  function count_by_id_general($table, $id, $val)
  {
    ...
    function sum_by_id_general($table, $sum, $id, $val)
  {
    return $this->db->query("SELECT SUM($sum) as jumlah FROM $table WHERE $id = '$val'")->row();
  }
  ...
  function get_by_multi_id_general($table, $id, $val, $id2='', $val2='', $group_by='')
  {
  ...
  function get_by_multi_id_general_order_by($table, $id, $val, $id2='', $val2='', $order_by='',$order='')
  {
    $this->db->where($id, $val);
    if (!empty($id2) && !empty($val2)) {
      $this->db->where($id2, $val2);
  ...
  function update_triple_id_general($table, $id, $val, $id2, $val2, $id3, $val3, $data)
  {
    $this->db->where($id, $val);
    $this->db->where($id2, $val2);
    $this->db->where($id3, $val3);
  ...
  function update_fourth_id_general($table, $id, $val, $id2, $val2, $id3, $val3, $id4, $val4, $data)
  {
    $this->db->where($id, $val);
    $this->db->where($id2, $val2);
    $this->db->where($id3, $val3);
