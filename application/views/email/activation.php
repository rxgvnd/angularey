...
<p style="margin: 0; font-size: 22px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 26px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 22px;">Hello <strong><?php echo $username;?></strong>, pendaftaran berhasil</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="margin: 0; font-size: 14px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 21px; margin-top: 0; margin-bottom: 0;">
		Silahkan aktivasi akun kamu untuk masuk ke aplikasi
</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<div class="txtTinyMce-wrapper" style="font-size: 12px; line-height: 1.2; color: #555555; font-family: Cabin, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14px;">
<p style="margin: 0; font-size: 16px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 19px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 16px;">Untuk menyelesaikan proses pendaftaran kamu <br><span style="color: #132f40; font-size: 16px;"><strong>silahkan klik tombol aktivasi dibawah ini </strong></span></span></p>
<p style="margin: 0; font-size: 16px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 19px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 16px;">Jika tombol tidak berfungsi silahkan copy URL berikut ini <br><span style="color: #132f40; font-size: 16px;"><strong><?php echo base_url('auth/activate/'.my_simple_crypt($username,'e'));?></strong></span></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<a href="<?php echo base_url('auth/activate/'.my_simple_crypt($username,'e'));?>" style="text-decoration:none;display:inline-block;color:#132F40;background-color:#FFD500;border-radius:50px;-webkit-border-radius:50px;-moz-border-radius:50px;width:auto; width:auto;;border-top:1px solid #FFD500;border-right:1px solid #FFD500;border-bottom:1px solid #FFD500;border-left:1px solid #FFD500;padding-top:5px;padding-bottom:5px;font-family:Cabin, Arial, Helvetica Neue, Helvetica, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:20px;padding-right:20px;font-size:15px;display:inline-block;letter-spacing:undefined;"><span style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><span data-mce-style="font-size: 15px; line-height: 30px;" style="font-size: 15px; line-height: 30px;"><strong><span data-mce-style="line-height: 30px; font-size: 15px;" style="line-height: 30px; font-size: 15px;">AKTIVASI AKUN &gt;</span></strong></span></span></span></a>
