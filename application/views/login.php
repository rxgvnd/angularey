...
<head>
	...
	<link href="<?php echo base_url('assets/'); ?>plugins/jquery-ui/themes/base/minified/jquery-ui.min.css"
		rel="stylesheet" />
		...
		<div class="row">
			<div class="form-box col-md-8 col-sm-10 col-xs-12">
				...
				<div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 form-login" align="center">
					...
					<h2 align="center" class="text-grey text-light">Login</h2><br />
					<form method="post" action="<?php echo base_url('auth/login/do_login'); ?>">
						<?php echo $this->session->flashdata('notif'); ?>
						<div class="form-group">
							<i class="fa fa-user icon-input"></i> <input type="text" name="username" id="userid"
								class="form-control input-line" placeholder="Username"
								required="true" />
						</div>
						<div class="form-group">
							<div class="password">
						...
						<div class="form-group" align="center">
							<button type="submit" class="btn btn-flat btn-primary btn-block" id="btnLogin">Login <i
									class="fa fa-angle-right"></i></button>
							<br><br>
							<p>Don't have an account? Sign Up <a
									href="<?php echo base_url('auth/register');?>">Here</a>
							</p>
							<hr>
