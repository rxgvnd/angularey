    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/masterCourse/createCourse/doCreate/')); ?>"  enctype="multipart/form-data">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Nama Course" name="nama_course" required />
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Keterangan Course</label>
                <div class="col-md-10">
                  <textarea name="keterangan_course" id="keterangan_course" class="form-control" cols="30" rows="10"></textarea>
                </div>
                <script>
