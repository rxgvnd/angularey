    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/masterCourse/createSoal/doCreate/')); ?>"  enctype="multipart/form-data">
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="number" class="form-control" placeholder="Masukkan urutan soal" name="urutan_soal" required>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Isi Soal</label>
                <div class="col-md-10">
                  <textarea name="isi_soal" id="isi_soal" cols="30" rows="10" class="form-control" required></textarea>
                  <script>
              ...
              <script>
                function tipeSoal(val){
                  if(val == "essay"){
                    ...
                    $('#kunci_jawaban').removeAttr('required');
                    $('#jawaban_essay').attr('required',true);
                  }else if(val == "pilgan"){
                    $('#formEssay').attr('hidden',true);
                    $('#formPilgan').removeAttr('hidden');
                    $('#formPoint').removeAttr('hidden');
                    $('#kunci_jawaban').attr('required',true);
                    $('#jawaban_essay').removeAttr('required');
                  }else{
              ...
              <div id="formPilgan" hidden>
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <textarea name="jawaban_a" id="jawaban_a" cols="30" rows="10" class="form-control"></textarea>
                    <script>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <textarea name="jawaban_b" id="jawaban_b" cols="30" rows="10" class="form-control"></textarea>
                    <script>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <textarea name="jawaban_c" id="jawaban_c" cols="30" rows="10" class="form-control"></textarea>
                    <script>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <textarea name="jawaban_d" id="jawaban_d" cols="30" rows="10" class="form-control"></textarea>
                    <script>
              ...
              <div id="formEssay" hidden>
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" id="jawaban_essay" placeholder="Masukkan jawaban essay" name="jawaban_essay">
                  </div>
                </div>
              </div>
              <div id="formPoint" hidden>
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <input type="number" class="form-control" id="jumlah_exp" placeholder="Masukkan Exp Max" name="jumlah_exp">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label">Exp Min</label>
                  <div class="col-md-10">
                    <input type="number" class="form-control" id="exp_min"  placeholder="Masukkan Exp Min" name="exp_min">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label">Point Max</label>
                  <div class="col-md-10">
                    <input type="number" class="form-control" id="jumlah_point"  placeholder="Masukkan Point Max" name="jumlah_point">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label">Point Min</label>
                  <div class="col-md-10">
                    <input type="number" class="form-control" id="point_min"  placeholder="Masukkan Point Min" name="point_min">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label">Waktu Pengerjaan (Second)</label>
                  <div class="col-md-10">
                    <input type="number" class="form-control" id="time"  placeholder="Masukkan Waktu Pengerjaan (Second)" name="time">
                  </div>
                </div>
              </div>
            </div>
