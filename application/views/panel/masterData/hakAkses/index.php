    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse">
        ...
        <div class="panel-body">
          ...
          <a href="<?php echo base_url(changeLink('panel/masterData/createHakAkses')); ?>" class="btn btn-xs blue-rasp text-white pull-right" style="margin-left:10px">Tambah Hak Akses</a>
          <br />
          <br />
