            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/pengaturan/identitasAplikasi/doUpdate/')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">Saran dan Informasi</label>
                            <div class="col-md-10">
                                <textarea id="saran_informasi" name="saran_informasi" class="form-control" rows="8" cols="80"><?php echo $identitas[0]->saran_informasi; ?></textarea>
                            </div>
                        </div>
                        <script>
                            CKEDITOR.replace('saran_informasi');
                        </script>
                        <div class="form-group">
