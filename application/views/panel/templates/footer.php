	...
	<a href="javascript:;" class="btn btn-icon btn-circle pac-dream text-white btn-scroll-to-top fade" data-click="scroll-top"><i class="fa fa-angle-up"></i></a>
	...
	<script>
		function getEaster(){
			$.ajax({
				url:"<?php echo base_url('panel/dashboard/addEaster');?>",
				type:"POST",
				success:function(){
					location.replace('<?php echo base_url('panel/dashboard');?>')
				}
			})
		}
	</script>
